...
import com.example.emojikeyboard.databinding.VhChatLeftLayoutBinding;
...
public class ChatLeftVH extends ChatBaseVH<VhChatLeftLayoutBinding, ChatInfo> {
    ...
    public void bindData(ChatInfo chatInfo, int position) {
        binding.text.setText(chatInfo.message);//EmojiSpanBuilder.buildEmotionSpannable(binding.getRoot().getContext(), chatInfo.message));
