package com.example.emojikeyboard.keyboard.chat;
 ...
 * blog: yummylau.com
 */
public class ChatRightVH extends ChatBaseVH<com.example.emojikeyboard.databinding.VhChatRightLayoutBinding, ChatInfo> {

    public ChatRightVH(com.example.emojikeyboard.databinding.VhChatRightLayoutBinding binding) {
        super(binding);
    }

    @Override
    public void bindData(ChatInfo chatInfo, int position) {
        binding.text.setText(chatInfo.message);
